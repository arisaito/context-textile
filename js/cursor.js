...
var obj1 =
  '<a-entity id="left" position="-0.47 0 0.47" scale="0.4 0.4 0.4" animation="property: rotation; to: 0 720 0; loop: false; dur: 1000; easing: easeOutCubic"><a-torus rotation="0 0 0" scale="0.4 0.4 0.4" radius-tubular="0.1" color="#ece8e5"></a-torus><a-cylinder position="0.58 0 0" rotation="0 0 0" scale="0.5 1.2 0.5" color="#ece8e5"></a-cylinder><a-cylinder position="0.58 0.1 0" rotation="0 0 0" scale="0.4 1.1 0.4" color="#3a211a"></a-cylinder></a-entity><a-entity id="right" scale="0.4 0.4 0.4" position="0.35 0 -0.18" rotation="0 0 0" animation="property: rotation; to: 0 570 0; loop: false; dur: 1000; easing: easeOutCubic"><a-torus rotation="0 0 0" scale="0.3 0.3 0.3" radius-tubular="0.1" color="#ece8e5"></a-torus><a-cylinder position="0.58 0 0" rotation="0 0 0" scale="0.5 1.2 0.5" color="#ece8e5"></a-cylinder><a-cylinder position="0.58 0.1 0" rotation="0 0 0" scale="0.4 1.1 0.4" color="#3a211a"></a-cylinder></a-entity></a-entity><a-box position="0.6 -0.4 1" rotation="0 60 0" scale="3.5 0.05 3.5" color="#3a211a"></a-box>';
var obj2 =
  '<a-entity scale="0.5 0.5 0.5" animation="property: rotation; to: 0 720 0; loop: false; dur: 1000; easing: easeOutCubic"><a-torus radius-tubular="0.02" color="fbf0f0" radius="0.8"></a-torus><a-octahedron position="0 0.9 0" rotation="-90 0 0" scale="0.3 0.3 0.3" color="#ffb5b5"></a-octahedron></a-entity>';
var obj3 =
  '<a-entity scale="0.4 0.4 0.4" animation="property: rotation; to: 0 720 0; loop: false; dur: 1000; easing: easeOutCubic"><a-torus rotation="0 0 0" scale="0.3 0.3 0.3" radius-tubular="0.1" color="#fbf0f0"></a-torus><a-cylinder position="0.58 0 0" rotation="0 0 0" scale="0.5 1.2 0.5" color="#fbf0f0"></a-cylinder><a-cylinder position="0.58 0.1 0" rotation="0 0 0" scale="0.4 1.1 0.4" color="#3a211a"></a-cylinder></a-entity><a-box position="0.6 -0.4 1.65" rotation="0 60 0" scale="3.5 0.05 3.5" color="#dfd3d3"></a-box>';
var obj4 =
